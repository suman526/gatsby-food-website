...
export default class Menu extends Component {
    ...
    handleItems = category =>{
        ...
        if (category === "all"){
            this.setState(()=>{
                return {webItems:tempItems}
            })
        } else {
            let items = tempItems.filter(({node})=>node.category === category);
            this.setState(()=>{
                return {webItems:items}
            });
        }
    };
          ...
          return (
            <section className="menu py-5">
                <div className="container">
                    <Title title="Best Reviewed Food" />
                    <div className="row">
                        {/* categories */}
                        <div className="row mb-5">
                            <div className="col-14 mx-auto text-center">
